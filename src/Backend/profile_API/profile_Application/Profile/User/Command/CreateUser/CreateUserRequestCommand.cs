...
public class CreateUserRequestCommand : ICommandHandler<CreateUserCommand, BaseUser>
{
    ...
    public async Task<BaseUser> Handle(CreateUserCommand command, CancellationToken cancellationToken)
    {
        ...
        if (user.IsFailure)
        {
            ...
            throw new ProfileException(400, user.Error);
        }
